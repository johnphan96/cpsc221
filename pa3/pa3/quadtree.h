...
public:
   ...
   void pruneRecurse(Node* & subRoot, int tol);
   /*
   ...
   int pruneSizeRecurse(Node*& subRoot, int tol);
   /*
...
private:
   ...
   */
   ...
   /* =================== start of private PA3 functions ============== */
    ...
    void clearRecurse(Node* &subRoot);
    /**
    ...
    */
    ...
    void renderRecurse(PNG& png, Node * subRoot);

    Node* copyRecurse(const Node *other);
